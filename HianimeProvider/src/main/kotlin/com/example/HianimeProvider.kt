...
class HianimeProvider : MainAPI() {
    ...
    override val mainPage =
            mainPageOf(
                "$mainUrl/recently-added?page=" to "Nuevos en HiAnime",
                    "$mainUrl/recently-updated?page=" to "Últimos Episodios",
                    "$mainUrl/filter?status=2&language=1&sort=recently_updated&page=" to "Recientes con Subtitulos",
                    "$mainUrl/filter?status=2&language=2&sort=recently_updated&page=" to "Recientes con Doblaje en Inglés",
                    "$mainUrl/most-popular?page=" to "Más Populares",
                    "$mainUrl/most-favorite?page=" to "Los Favoritos",
                    "$mainUrl/completed?page=" to "Finalizados",
            )
