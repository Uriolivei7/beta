...
abstract class AbstractC0767b {
    ...
    private static class c implements Comparator {
        ...
        private final Rect f10910a = new Rect();
        ...
        public int compare(Object obj, Object obj2) {
            Rect rect = this.f10910a;
            Rect rect2 = this.f10911b;
            this.f10913d.a(obj, rect);
            this.f10913d.a(obj2, rect2);
            int i3 = rect.top;
            int i4 = rect2.top;
            if (i3 < i4) {
                return -1;
    ...
    public static Object c(Object obj, InterfaceC0153b interfaceC0153b, a aVar, Object obj2, Rect rect, int i3) {
        ...
        int iB = interfaceC0153b.b(obj);
        Rect rect3 = new Rect();
        Object obj3 = null;
        for (int i4 = 0; i4 < iB; i4++) {
            Object objA = interfaceC0153b.a(obj, i4);
            if (objA != obj2) {
                aVar.a(objA, rect3);
    ...
    public static Object d(Object obj, InterfaceC0153b interfaceC0153b, a aVar, Object obj2, int i3, boolean z3, boolean z4) {
        int iB = interfaceC0153b.b(obj);
        ArrayList arrayList = new ArrayList(iB);
        for (int i4 = 0; i4 < iB; i4++) {
            arrayList.add(interfaceC0153b.a(obj, i4));
        }
