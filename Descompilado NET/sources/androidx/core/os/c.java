...
public abstract class c {
    public static final Bundle a(C0686i... c0686iArr) {
        Bundle bundle = new Bundle(c0686iArr.length);
        for (C0686i c0686i : c0686iArr) {
            String str = (String) c0686i.a();
            Object objB = c0686i.b();
            if (objB == null) {
                ...
                D2.h.c(componentType);
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    D2.h.d(objB, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) objB);
                } else if (String.class.isAssignableFrom(componentType)) {
                    D2.h.d(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) objB);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    D2.h.d(objB, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
