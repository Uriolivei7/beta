    ...
    private boolean A(int i3, int i4) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == d.f.f8783P) {
                    view = childAt;
                } else if (id == d.f.f8794k) {
                    view2 = childAt;
                } else {
                    if ((id != d.f.f8796m && id != d.f.f8798o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.T$a r15 = (androidx.appcompat.widget.T.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = r17.getLayoutDirection()
            int r2 = androidx.core.view.AbstractC0275w.a(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
