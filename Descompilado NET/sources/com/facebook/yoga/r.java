...
public abstract class r {
    public abstract void A(j jVar, float f3);
    ...
    public abstract void L(m mVar, float f3);

    public abstract void M(m mVar, float f3);

    public abstract void N(float f3);

    public abstract void O();

    public abstract void P(float f3);

    public abstract void Q(n nVar);

    public abstract void R(j jVar, float f3);

    public abstract void S(j jVar);

    public abstract void T(j jVar, float f3);
    ...
    public abstract void b(r rVar, int i3);
    ...
    public abstract void e0(j jVar, float f3);

    public abstract h f();

    public abstract void f0(j jVar, float f3);

    public abstract float g();

    public abstract void g0(j jVar, float f3);

    public abstract float h(j jVar);

    public abstract void h0(j jVar, float f3);
