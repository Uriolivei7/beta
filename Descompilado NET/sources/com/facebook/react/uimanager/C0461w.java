...
public final class C0461w {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final C0461w f7633a = new C0461w();
    ...
    public static final boolean a(ViewGroup viewGroup) {
        ...
        Iterator it = AbstractC0248f0.a(viewGroup).iterator();
        while (it.hasNext()) {
            if (((View) it.next()).getTag(AbstractC0505m.f9245r) != null) {
                return true;
            }
        }
        return false;
