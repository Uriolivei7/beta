...
public final class ReadableNativeMap$entryIterator$1$1 implements Iterator<Map.Entry<? extends String, ? extends Object>>, E2.a {
    ...
    public Map.Entry<? extends String, ? extends Object> next() {
        ...
        return new ReadableNativeMap$entryIterator$1$1$next$1(this.$iteratorKeys, i3, this.$iteratorValues);
    }
}
