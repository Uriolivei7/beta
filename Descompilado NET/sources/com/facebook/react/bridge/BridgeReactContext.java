...
public class BridgeReactContext extends ReactApplicationContext {
    ...
    public CatalystInstance getCatalystInstance() {
        return (CatalystInstance) C0210a.c(this.mCatalystInstance);
    }
    ...
    public void handleException(Exception exc) {
        CatalystInstance catalystInstance = this.mCatalystInstance;
        boolean z3 = catalystInstance != null;
        boolean z4 = z3 && !catalystInstance.isDestroyed();
        boolean z5 = getJSExceptionHandler() != null;
        if (z4 && z5) {
            getJSExceptionHandler().handleException(exc);
            return;
        }
        Y.a.n("ReactNative", "Unable to handle Exception - catalystInstanceVariableExists: " + z3 + " - isCatalystInstanceAlive: " + z4 + " - hasExceptionHandler: " + z5, exc);
    ...
    public void registerSegment(int i3, String str, Callback callback) {
        ((CatalystInstance) C0210a.c(this.mCatalystInstance)).registerSegment(i3, str);
