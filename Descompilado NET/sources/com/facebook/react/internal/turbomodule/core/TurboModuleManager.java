...
public class TurboModuleManager implements TurboModuleRegistry {
    ...
    private NativeModule getOrCreateModule(String str, ModuleHolder moduleHolder, boolean z3) {
        boolean z4;
        NativeModule module;
        synchronized (moduleHolder) {
            try {
                ...
                if (module2 != null) {
                    ...
                    Y.a.o(TAG, "getOrCreateModule(): Unable to create module \"%s\" (legacy: %b, turbo: %b)", str, Boolean.valueOf(isLegacyModule(str)), Boolean.valueOf(isTurboModule(str)));
                }
    ...
    private native void installJSIBindings(boolean z3);
    ...
    public static /* synthetic */ NativeModule lambda$new$2(TurboModuleManagerDelegate turboModuleManagerDelegate, String str) {
        ...
        C0210a.b(!(legacyModule instanceof TurboModule), "NativeModule \"" + str + "\" is a TurboModule");
        return legacyModule;
    }
        ...
        synchronized (this.mModuleCleanupLock) {
            try {
                if (this.mModuleCleanupStarted) {
                    Y.a.o(TAG, "getModule(): Tried to get module \"%s\", but TurboModuleManager was tearing down (legacy: %b, turbo: %b)", str, Boolean.valueOf(isLegacyModule(str)), Boolean.valueOf(isTurboModule(str)));
                    return null;
                }
