...
class ByseHttpExtractor {
    ...
    suspend fun extract(embedUrl: String, embedParent: String, embedOrigin: String): List<ByseSource> {
        ...
        Log.d("Danimados", "[Byse] origin=$origin mediaId=$mediaId")
        ...
        Log.d("Danimados", "[Byse] attest ok: token=${attest.token.take(16)}... viewer=${attest.viewerId} confidence=${attest.confidence}")
        ...
        Log.d("Danimados", "[Byse] captcha difficulty=${captcha.powDifficulty}")
        ...
        Log.d("Danimados", "[Byse] captcha ok (token ${captchaToken.take(12)})")
        ...
        Log.d("Danimados", "[Byse] decrypted len=${decryptedJson.length}")
