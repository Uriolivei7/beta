...
public final class PrimeVideoMirrorProvider extends MainAPI {
    ...
    /* JADX INFO: compiled from: PrimeVideoMirrorProvider.kt */
    @Metadata(k = 3, mv = {2, 3, 0}, xi = 48)
    @DebugMetadata(c = "com.horis.cncverse.PrimeVideoMirrorProvider", f = "PrimeVideoMirrorProvider.kt", i = {0, 1, 1, 1}, l = {131, 138}, m = "search", n = {"query", "query", "cookies", "url"}, nl = {133, 573}, s = {"L$0", "L$0", "L$1", "L$2"}, v = 2)
